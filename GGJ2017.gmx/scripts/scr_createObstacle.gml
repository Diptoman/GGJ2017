...
else if (obstacle == obstacleType.Floating)
{
    scr_createFloatingObstacle(sideType, sizeOfObstacle);
}
...
var sizeOfObstacle = argument1;
    ...
    {    
        ...
        inst1.sprite_index = choose(spr_triangle1, spr_triangle2, spr_round1, spr_round2);
    }
    //Bottom shadow
    ...
    {    
        ...
        if (sideType == obstacleSide.BothDown)
            ...
            inst2.sprite_index = choose(spr_triangle1, spr_triangle2, spr_round1, spr_round2);
        inst2._yDir = -1;
    }
    //Top shadow
...
instance_create(room_width, room_height/2, obj_switchzone);

#define scr_createFloatingObstacle
var inst1, inst2;
var sideType = argument0;
var sizeOfObstacle = argument1;

inst1 = instance_create(room_width, room_height/2 - 180, obj_floatingObstacle);
inst1._size = sizeOfObstacle;
inst1.sprite_index = choose(spr_floating1, spr_floating2);
inst2 = instance_create(room_width, room_height/2 + 180, obj_floatingObstacle);
inst2._size = sizeOfObstacle;
inst2.sprite_index = inst1.sprite_index;
inst2._yDir = -1;
